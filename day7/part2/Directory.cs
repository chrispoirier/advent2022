...
namespace part2
{
    internal class Directory
    {
        ...
        internal int SizeOfDeleteDir(int deleteMinSize)
        {
            var sizes = GetDirSizes();
            var bigEnough = sizes.Where(s => s >= deleteMinSize);
            return bigEnough.Min();
        }
